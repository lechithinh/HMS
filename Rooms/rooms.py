                                        ...
                                        with col3_button:   
                                            ...
                                            if Update_Room_Button:
                                                ...
                                                if check_valid_info == False:
                                                    ...
                                                    isUpdate = True
                                                    #update room
                                                    mydb.update_room(room_name,floor,room_type,room_price,room_bed,max_pp,table['Room ID'][index])
                    ...
                    with col_4:
                        ...
                        if Add_room_button:
                            ...
                            if check_valid_info == False:
                                ...
                                isNoti = True
                                mydb.add_a_room(room_name, floor, room_type, room_price, beds, people)
