...
def StaffProfile(mydb,staff_id):
    ...
    with st.form("Add a new item"):              
        with st.container():
                ...
                with row_2_2:
                    #staff_date = st.text_input("Your Date Of Birth", staff_data[3])
                    staff_date = st.date_input("Your Date Of Birth",value=staff_data[3])
                with row_3_1:
                    staff_username = st.text_input("Your User Name", staff_data[4])
                with row_3_2:
                    ...
                    with col6:
                        ...
                        if update_profile:
                            mydb.Update_One_Staff(staff_id,staff_name,staff_phone,staff_address,staff_date,staff_username,staff_role)